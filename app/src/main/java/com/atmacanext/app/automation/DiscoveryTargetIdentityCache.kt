 ...
 * DiscoveryProfileEvidence. It is used only to expand X's ellipsized feed header
 * (for example @bosunat...) back to that same verified target; it never proves a
 * new profile or a follow target by itself.
 */
