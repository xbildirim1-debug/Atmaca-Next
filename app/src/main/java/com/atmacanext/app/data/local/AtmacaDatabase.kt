...
@Database(
    entities = [
        AccountEntity::class,
        TaskEntity::class,
        RuntimeCheckpointEntity::class,
        AutomationLogEntity::class,
        QueueCheckpointEntity::class,
        QueueItemEntity::class,
        DailyAccountUsageEntity::class,
        TargetAccountEntity::class,
    ],
    version = 4,
    exportSchema = false,
)
    ...
    companion object {
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL(
                    ...
                    CREATE TABLE IF NOT EXISTS daily_account_usage (
                        ...
                        updatedAt INTEGER NOT NULL,
                        PRIMARY KEY(dateKey, accountId, actionType)
                    )
                    """.trimIndent()
                )
            }
        ...
        internal val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                // The user explicitly removed daily clock automation.
                db.execSQL("DROP TABLE IF EXISTS task_schedules")

                // V23 shipped demo rows. Remove only their exact known identities; real rows stay intact.
        ...
        fun create(context: Context): AtmacaDatabase = Room.databaseBuilder(
            context.applicationContext,
            AtmacaDatabase::class.java,
            "atmaca_next.db",
        )
